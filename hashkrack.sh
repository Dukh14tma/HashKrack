...
echo "${bold}${red}$author${reset}"                                                                                                                                                                                                                                                                                                                                 # Prompt user for input
read -p "${bold}${red}[+]${green}    Enter the hash to crack: " hash_to_crack
echo                                                                                                                                                                              read -p "${bold}${red}[+]${green}    Enter the path to the wordlist file: " wordlist ${reset}                                                                                                                                                                                                                                                                       # List of hashing algorithms                                                                                                                                                      algorithms=("md5" "sha1" "sha224" "sha256" "sha384" "sha512" "ripemd160" "whirlpool" "tiger128,3" "tiger160,3" "tiger192,3" "tiger128,4" "tiger160,4" "tiger192,4" "snefru" "gost" "adler32" "crc32" "crc32b" "fnv132" "fnv164" "joaat" "haval128,3" "haval160,3" "haval192,3" "haval224,3" "haval256,3" "haval128,4" "haval160,4" "haval192,4" "haval224,4" "haval2
56,4" "haval128,5" "haval160,5" "haval192,5" "haval224,5" "haval256,5")

# Loop through algorithms and wordlist
for algorithm in "${algorithms[@]}"; do
  while read -r password; do
    case $algorithm in                                                                                                                                                                  "md5")
      ...
      "snefru" | "gost" | "adler32" | "crc32" | "crc32b" | "fnv132" | "fnv164" | "joaat" | "haval128,3" | "haval160,3" | "haval192,3" | "haval224,3" | "haval256,3" | "haval128,4"
